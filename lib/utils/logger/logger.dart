...
class AppLogger {
  ...
  void e(String? text, {String? tag, bool showTime = false, StackTrace? stackTrace, Exception? exception}) {
    String? error = exception.toString();
    _log(text, _LogStatusError(), error: error, stackTrace: stackTrace);
  }

  void exception(Object? exception, {String? tag, bool showTime = false, StackTrace? stackTrace}) {
    String? text = exception?.toString();
    _log(text, _LogStatusError(), stackTrace: stackTrace, tag: tag);
  }
